...
const WeatherApp = () => {
  ...
  let api_key = "b8398a4990bd4d0cf461f2faa7a0423d";
  ...
  //   const location = document.getElementsByName("weather-location");

  //   humidity[0].innerHTML = data.main.humidity;
  //   wind[0].innerHTML = data.wind.speed;
  //   temprature[0] = data.main.temp;
  ...
  const data = {
    weather: [
      { icon: "01d" }, // Example weather icon data
